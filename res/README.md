...
1.不能点的连接都隐藏
2.用户设置，关注品种错位  增加一行变成增加
3.UpdateUserHandler 没有return
4.即可采购默认显示两行
5.发布采购单成功后  我的采购 我的工作台 url不对
6.发布采购单  一发布就报价结束
7.我的采购  等待报价和报价结束  都能关闭  对单个品种不能关闭
8.session存储uploadfiles数据结构不一样  统一为{'1',['http://']}
9.图片莫名删除
10.mobile端 采购单详情的质量要求
11.首页采购单品种默认只显示三个
12."我的采购"只看"意向供货商"隐藏  pc端采购订单隐藏  “我的采购”列表 最低价功能    我的采购 采购单详情  报价“价格说明”放在价格的下面  最低的价格后有“最低”
