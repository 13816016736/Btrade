...
雄军：
移动端页面
1.首页列表 显示品种名  大图显示不出来
2.android 三星note2 采购单页面大图浏览返回按钮及关闭按钮没有
3.未登陆首页登陆提示
4.移动端退出
5.登陆页面强化注册入口
6.注册成功，报价成功顶部灰色
7.注册成功点击返回之前报价的采购单的页面
8.公众号关注页面返回首页
9.android 三星note2 拍照和上传图片的bug
10.发布采购单品种中等级规格没有怎么办？戴总他们讨论结果


11.pc端采购单发布成功的页面,那些统计的信息显示出来是否有必要.      发布采购单成功页面文案调整  
12.平台都去掉认证的概念,因为还没有认证  认证概念去掉
qq分享的功能，不要“复制”按钮
把发送短信改成关注药材购微信公众号
13.缺favicon图片
14.我的工作台 采购单时间倒序排列
15.修改采购单 质量要求 照片有问题  品种顺序有问题  增加一行不复制上一个品种的填写   修改成功不推送   
16.采购单excel导入  导入上次品种报价？？？
17.用户类型文案调整待定 统一文案
18.报价成功第一次报价 突出文案
19.移动端所有发布成功页面 直接放上公众号二维码
20.我的报价排序 时间倒序  采购人信息取错了  报价时间  报价id改成采购单编码
21.boss回复报价 逆向，正向流程有bug
22.boss看大图  
23.联系采购商 拨电话
24.报价详情页  认可报价  地步是联系采购商  拨电话
25.未关注品种  样式调整
26.首页排序规则思考
27.关注品种 输入选择后 清空输入内容和提示内容
